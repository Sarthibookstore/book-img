...
$(document).ready(function () {
    ...
    $.get("https://script.google.com/macros/s/AKfycbzJUjvNdpQw7ZKgFAqPomGkI5Xy0Ngbswr2mAgoydfr98FGk2A3euDXSxz6S1YJ0Q/exec", function (data) {
...
function submitForm() {
    ...
    $.ajax({
        ...
        url: 'https://script.google.com/macros/s/AKfycbwW-hiYELbLOm4GAQPF6Qww0HE0D7m_DOtk11BgpEckh0tTMXP6sDv-UFJUagGmcVsc/exec',
        type: 'post',
        data: {
            'fullname': fullname,
            'address': address,
