...
$(document).ready(function () {
    ...
    $.get("https://script.google.com/macros/s/AKfycbzXgM8Mkds8OgcN_BdpSM3kfmcj40hTR1kvLzH3ys2aQNyXyEoqc6E5m1eRtp0mBOHA/exec", function (data) {
...
function submitForm() {
    ...
    $.ajax({
        ...
        url: 'https://script.google.com/macros/s/AKfycbx39l8kJJKgvXgcQPKd2lpDUD346JL5iVYCwcT4s9PL8mlB98jF0fgmnPKa9Nd2TDjk/exec',
        type: 'post',
        data: {
            'fullname': fullname,
            'address': address,
