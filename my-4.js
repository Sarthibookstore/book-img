...
$(document).ready(function () {
    ...
    $.get("https://script.google.com/macros/s/AKfycbzXS8G50QnDrhILAjs4T8pDCk59vaMB7xOKGzpC5PQoR2krwxacrTXiaJp3ehclQv6jNQ/exec", function (data) {
...
function submitForm() {
    ...
    $.ajax({
        ...
        url: 'https://script.google.com/macros/s/AKfycbw2Tn5u9yJTf35243ejKOYvo3LVSEeD2_mlnFO2bUCBYFl4zt5cdnrbUsog7A050ThO/exec',
        type: 'post',
        data: {
            'fullname': fullname,
            'address': address,
