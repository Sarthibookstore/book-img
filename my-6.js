...
$(document).ready(function () {
    ...
    $.get(
      "https://script.google.com/macros/s/AKfycbwknmDv1bFAx-xwsRbWC_PyUXAOYlrlplayqbb8BJ6sjPsXUIOGYoFflI2lTJ5f758UCA/exec",
      function (data) {
...
function submitForm() {
    ...
    $.ajax({
        ...
        url: 'https://script.google.com/macros/s/AKfycbyTUPqTR2xwe2c4r8tOpfGsD2jXo40S22lvwJJ42wGGpWTTNjiyB5bWWreNPNRo3G1USw/exec',
        type: 'post',
        data: {
            'fullname': fullname,
            'address': address,
