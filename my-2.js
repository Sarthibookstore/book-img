...
$(document).ready(function () {
    ...
    $.get("https://script.google.com/macros/s/AKfycbxyY9iZyW4L_7xXd_boYcRcRH49lGP5YM88lCRagfquC8rtRoS-Ki3O1W5o87u-Q29HqA/exec", function (data) {
...
function submitForm() {
    ...
    $.ajax({
        ...
        url: 'https://script.google.com/macros/s/AKfycbxjy0mWHJ6dm9rLDtYmuFSl9KR1ZEOpdXFme2P7WOzArh1AMaMWZjlb-XEOeFO0b5V1/exec',
        type: 'post',
        data: {
            'fullname': fullname,
            'address': address,
